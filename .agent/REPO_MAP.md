...
- `tools/sentry_grounding.py` / `tools/sentry_ask.py` — bounded routine fact packets and maturity-aware routine conversation layered onto the existing M4 path.
