...
- `perception/sentry_perception.py` — observation-only local webcam service, OpenCV HOG detector, bounded latest-frame buffer, two-stage IoU tracker, health states, and metrics.
